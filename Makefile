SRCS    = ft_bzero.c ft_isalnum.c ft_isascii.c ft_isalpha.c ft_isdigit.c ft_isprint.c ft_memchr.c ft_memcmp.c \
			...
			ft_tolower.c ft_toupper.c ft_strnstr.c ft_atoi.c ft_substr.c #ft_calloc.c ft_strdup.c  ft_strjoin.c ft_strtrim.c ft_split.c ft_itoa.c ft_strmapi.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c \
